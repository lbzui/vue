<template>
  <article class="lbzui-components-button">
    ...
    <h3 class="lbz-typography--subtitle1">
      $ router-link-props (router-link): { to: '' (default) || 'x' || { x: y },
      replace: true || false (default), append: true || false (default), exact:
      true || false (default), event: 'click' (default) || 'x' || ['x'] }
    </h3>
    <h3 class="lbz-typography--subtitle1">
    ...
    >
    <lbz-button tag="a" href="#/components/button" icon="add"
      >Non-router-link</lbz-button
    >

    <h3 class="lbz-typography--subtitle1">
      $ color: 'primary' (default), 'secondary', 'surface', 'error', 'light',
      'dark'
    </h3>
    ...
    <lbz-button color="secondary" disabled icon="add">Secondary</lbz-button>
    <br />
    <lbz-button color="surface" disabled>Surface</lbz-button>
    <lbz-button color="surface" disabled icon="add">Surface</lbz-button>
    <br />
    <lbz-button color="error" disabled>Error</lbz-button>
    <lbz-button color="error" disabled icon="add">Error</lbz-button>
    <br />
    <div class="lbzui-mini-rectangle lbzui-background--dark">
      <lbz-button color="light" disabled>Light</lbz-button>
      <lbz-button color="light" disabled icon="add">Light</lbz-button>
    </div>
    <br />
    <div class="lbzui-mini-rectangle lbzui-background--light">
      <lbz-button color="dark" disabled>Dark</lbz-button>
      <lbz-button color="dark" disabled icon="add">Dark</lbz-button>
    </div>
    ...
    <lbz-button
      ...
      >Router-link</lbz-button
    >
    <lbz-button tag="a" href="#/components/button" type="outlined" icon="add"
      >Non-router-link</lbz-button
    >
    ...
    <lbz-button type="outlined" color="secondary" icon="add"
      >Secondary</lbz-button
    >
    <br />
    <lbz-button type="outlined" color="surface">Surface</lbz-button>
    <lbz-button type="outlined" color="surface" icon="add">Surface</lbz-button>
    <br />
    <lbz-button type="outlined" color="error">Error</lbz-button>
    <lbz-button type="outlined" color="error" icon="add">Error</lbz-button>
    <br />
    <div class="lbzui-mini-rectangle lbzui-background--dark">
      <lbz-button type="outlined" color="light">Light</lbz-button>
      <lbz-button type="outlined" color="light" icon="add">Light</lbz-button>
    </div>
    <br />
    <div class="lbzui-mini-rectangle lbzui-background--light">
      <lbz-button type="outlined" color="dark">Dark</lbz-button>
      <lbz-button type="outlined" color="dark" icon="add">Dark</lbz-button>
    </div>
    ...
    <lbz-button type="outlined" full-width icon="add">Full-width</lbz-button>
    ...
    <lbz-button type="outlined" :dense="false" icon="add">Non-dense</lbz-button>

    <h3 class="lbz-typography--subtitle1">$ disabled: true, false (default)</h3>

    <lbz-button type="outlined" disabled>Primary</lbz-button>
    <lbz-button type="outlined" disabled icon="add">Primary</lbz-button>
    <br />
    <lbz-button type="outlined" color="secondary" disabled
      >Secondary</lbz-button
    >
    <lbz-button type="outlined" color="secondary" disabled icon="add"
      >Secondary</lbz-button
    >
    <br />
    <lbz-button type="outlined" color="surface" disabled>Surface</lbz-button>
    <lbz-button type="outlined" color="surface" disabled icon="add"
      >Surface</lbz-button
    >
    <br />
    <lbz-button type="outlined" color="error" disabled>Error</lbz-button>
    <lbz-button type="outlined" color="error" disabled icon="add"
      >Error</lbz-button
    >
    <br />
    <div class="lbzui-mini-rectangle lbzui-background--dark">
      <lbz-button type="outlined" color="light" disabled>Light</lbz-button>
      <lbz-button type="outlined" color="light" disabled icon="add"
        >Light</lbz-button
      >
    </div>
    <br />
    <div class="lbzui-mini-rectangle lbzui-background--light">
      <lbz-button type="outlined" color="dark" disabled>Dark</lbz-button>
      <lbz-button type="outlined" color="dark" disabled icon="add"
        >Dark</lbz-button
      >
    </div>
    ...
    <lbz-button type="outlined" :ripple="false" icon="add"
      >Non-ripple</lbz-button
    >
    ...
    <lbz-button
      ...
      >Router-link</lbz-button
    >
    <lbz-button tag="a" href="#/components/button" type="contained" icon="add"
      >Non-router-link</lbz-button
    >
    ...
    <lbz-button type="contained" color="secondary" icon="add"
      >Secondary</lbz-button
    >
    <br />
    <lbz-button type="contained" color="surface">Surface</lbz-button>
    <lbz-button type="contained" color="surface" icon="add">Surface</lbz-button>
    <br />
    <lbz-button type="contained" color="error">Error</lbz-button>
    <lbz-button type="contained" color="error" icon="add">Error</lbz-button>
    <br />
    <lbz-button type="contained" color="light">Light</lbz-button>
    <lbz-button type="contained" color="light" icon="add">Light</lbz-button>
    <br />
    <lbz-button type="contained" color="dark">Dark</lbz-button>
    <lbz-button type="contained" color="dark" icon="add">Dark</lbz-button>
    ...
    <lbz-button type="contained" full-width icon="add">Full-width</lbz-button>
    ...
    <lbz-button type="contained" :dense="false" icon="add"
    ...
    <lbz-button type="contained" disabled icon="add">Primary</lbz-button>
    <br />
    <lbz-button type="contained" color="secondary" disabled
      >Secondary</lbz-button
    >
    <lbz-button type="contained" color="secondary" disabled icon="add"
      >Secondary</lbz-button
    >
    <br />
    <lbz-button type="contained" color="surface" disabled>Surface</lbz-button>
    <lbz-button type="contained" color="surface" disabled icon="add"
      >Surface</lbz-button
    >
    <br />
    <lbz-button type="contained" color="error" disabled>Error</lbz-button>
    <lbz-button type="contained" color="error" disabled icon="add"
      >Error</lbz-button
    >
    <br />
    <lbz-button type="contained" color="light" disabled>Light</lbz-button>
    <lbz-button type="contained" color="light" disabled icon="add"
      >Light</lbz-button
    >
    <br />
    <lbz-button type="contained" color="dark" disabled>Dark</lbz-button>
    <lbz-button type="contained" color="dark" disabled icon="add"
      >Dark</lbz-button
    >
    ...
    <lbz-button type="contained" :ripple="false" icon="add"
      >Non-ripple</lbz-button
    >
  </article>
</template>
